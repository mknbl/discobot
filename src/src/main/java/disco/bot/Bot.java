        ...
        client.getEventDispatcher().on(MessageCreateEvent.class)
                .subscribe(event -> {
                    ...
                    if (event.getMessage().getContent().toLowerCase().equals("!preqwek")) {
                        ...
                        event.getMessage().getChannel().flatMap(channel -> channel.createMessage("```" + finalMessage + "```")).subscribe();
                    }
                    ...
                    if (event.getMessage().getContent().toLowerCase().contains("!generalkagt4")) {
                        ...
                        event.getMessage().getChannel().flatMap(channel -> channel.createMessage("```" + finalMessage + "```")).subscribe();
                        event.getMessage().getChannel().flatMap(channel -> channel.createMessage("```" + finalMessage2 + "```")).subscribe();
                    }
